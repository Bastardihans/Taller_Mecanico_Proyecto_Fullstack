...
public class AgendaService {
    ...
    public AgendaResponseDTO crearCita(AgendaRequestDTO request) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_GATEWAY, "No fue posible validar al cliente externo.", e);
        } catch (Exception e) {
            // 8. Si Feign devuelve un error (ej: 404 de Hans), cae aquí y lanzamos una excepción propia
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Ocurrió un error inesperado al agendar la cita.", e);
        }
